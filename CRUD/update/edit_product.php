<?php
   ...
   define('__component_edit__', dirname(dirname(__FILE__)));
   require_once(__component_edit__.'../update/component_edit.php');
   //require_once ('CRUD/update/component_edit.php');

   define('__shop_db3__', dirname(dirname(__FILE__)));
   require_once(__shop_db3__.'../../database/Shop_db.php');
