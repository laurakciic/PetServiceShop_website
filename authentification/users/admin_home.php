...
<body>
    ...
    <section class="home" id="home">
        ...
        <div class="content">
            ...
            <a href="../../CRUD/read/shop.php" class="btn">view products</a>
            <hr>
            <a href="../../CRUD/create/create_product.php" class="btn">create product</a>
            <hr>
            <a href="../../CRUD/update/edit_product.php" class="btn">update product</a>
            <hr>
            <a href="../../CRUD/delete/delete_product.php" class="btn">delete product</a>
        </div>
